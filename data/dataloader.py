...
from data.constant import tusimple_row_anchor, culane_row_anchor, yq_row_anchor
from data.dataset import LaneClsDataset, LaneTestDataset

def get_train_loader(batch_size, data_root, griding_num, dataset, use_aux, distributed, num_lanes,data_file='train_gt_train.txt'):
    ...
    if dataset == 'CULane':
        ...
        train_dataset = LaneClsDataset(data_root,
                                           os.path.join(data_root, data_file),
                                           img_transform=img_transform, target_transform=target_transform,
                                           simu_transform = simu_transform,
                                           griding_num=griding_num, 
